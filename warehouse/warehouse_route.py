...
@warehouse_router.post("/coverage_gap_warehouses", response_model=ResponseModel[CoverageAnalysisResponse])
...
@warehouse_router.post("/ai_analysis", response_model=ResponseModel[AIAnalysisData])
